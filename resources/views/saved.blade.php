...
<div class="main">
    ...
    <div class="post">
        <div class="post_del">
            <div>
                <img src="./assets/img/stories/s4.jpg" alt="">
            </div>
             <div>
        ...
        <div class="post_img">
            <img src="./assets/img/stories/s1.jpg" alt="">
        </div>
    ...
    <div class="post">
        <div class="post_del">
            <div>
                <img src="./assets/img/stories/s2.jpg" alt="">
            </div>
             <div>
                <h5>Nome da Pessoa</h5>
                <span>3dias </span>
        ...
        <p>Esta é a área onde ficará descrição da publicação</p>
        <div class="post_img">
            <img src="../img/stories/s6.jpg" alt="">
        </div>
    ...
    <div class="post">
        ...
        <p>Esta é a área onde ficará descrição da publicação</p>
        <div class="post_img">
            <img src="../img/stories/s5.jpg" alt="">
        </div>
